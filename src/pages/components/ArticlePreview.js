    ...
    <div className="ArticlePreview">
      <div className={`flex ${props.topStory ? 'flex-col-reverse' : 'flex-row h-full'}`}>
        <div className={`article-text ${props.topStory ? 'w-full' : 'w-4/5'}`}>
          <p className="uppercase text-lg line-clamp-1">Written by <span className="font-bold">Gabrielle Canon</span></p>
          <h2 className={`font-extrabold line-clamp-2 ${props.topStory ? 'text-4xl' : 'text-xl'}`}>Free 
          ...
          {props.topStory &&
            <p className="line-clamp-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod 
